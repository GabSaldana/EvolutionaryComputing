...
def ec(w,x,y,l,a,sl,da,n): #(grahics,inicio x,inicio y, largo,angulo ini, desviacion angulo, ,no de veces)
    if n==0:
        return
...
##1
    #ec(w,(x+x2)/1,(y+y2)/1,l*sl,a-da,sl,da,n-1)
    #ec(w,(x2)/1,(y2)/1,l*sl,a-da,sl,da,n-1)
...
##2
#ec(w,250,250,150,180,0.97,33,50)

##3
#ec(w,10,280,200,120,0.8,20,5)

##4
#ec(w,10,180,150,120,0.8,30,10)

##5
##ec(w,150,150,10,30,1,50,250)
##ec(w,150,150,200,30,1,500,250)
##ec(w,250,250,50,20,1,1000,250)
ec(w,250,250,50,20,1,1000,100)
