...
void main()
{
  ...
  sonido(900); w0=7; w1=1; w3=346; for (w2=373;w2>=340;w2-=7) animac(2,-9,1);

  cleardevice(); sonido(900);
/*  yi1=330; xi1=240; w0=7; w1=6; w2=172; w3=186; animac1(1,1,5);*/
  yi1=330; xi1=240; w0=7; w1=6; w2=72; w3=343; animac1(1,1,1);
  yi1=300; xi1=265; w0=-27; w1=6; w2=172; w3=1; animac1(2,1,5);
  xi1=325; w0=-25; w1=6; w2=172; w3=1; animac1(2,1,5);
  xi1=390; w0=-23; w1=6; w2=172; w3=191;  animac1(3,1,5);
