...
void main()
{
  ...
  while(car!=27){
    ...
    while((random(15)!=4) && (kbhit()==0)){
      ...
      c3--;
      setcolor(c3);
    if(selecc==0) caracol0(250+i*s,250-i,tam,0);

    if(selecc==1) caracol1(250+i*s,250-i,tam,0);

    if(selecc==2) caracol2(250+i*s,250-i,tam,0);

    if(selecc==3) caracol3(250+i*s,250-i,tam,0);

    if(selecc==4) caracol4(250+i*s,250-i,tam,0);

    if(selecc==5) caraco3(250+i*s,250-i,tam,0);

    while((random(70)!=2) && (kbhit()==0)){
      escrcolordac16(0,k1/97,k1/197,ba+k1/17); k1++;
      k=k+random(7)-2;
      for(j=1;j<16;j++)
