...
void main()
{
  ...
  while(car!=27){
	...
	c3=random(15)+1;
	setcolor(c3);}
    if(selecc==0) caracol0(250+i*s,250-i,35,0);

    if(selecc==1) caracol1(250+i*s,250-i,35,0);

    if(selecc==2) caracol2(250+i*s,250-i,35,0);

    if(selecc==3) caracol3(250+i*s,250-i,35,0);

    if(selecc==4) caracol4(250+i*s,250-i,35,0);

    if(selecc==5) caraco3(250+i*s,250-i,35,0);
    }
    if (kbhit())car=getch();
    else delay(2000);
    i=0;
