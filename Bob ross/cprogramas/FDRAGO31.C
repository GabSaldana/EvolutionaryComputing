...
void main()
{
  ...
  while(car!=27){
    ...
    ang2=3+random(360);
    ang3=-35+random(76);
    gotoxy(1,1);printf("fractal de dragon31 ang1=%d ang2=%d",ang1,ang2);
...
void caracol(int x0,int y0,float l,int an)
{
  ...
  if (l >=1 )               //47, 127, 12
  {
    ...
    y1=y0+(l*sin(an/57.29578));
    line(x0,y0,x1,y1);
    setcolor(c3+c11); caracol(x1,y1,l-15,an+ang1);
    setcolor(c2+c11); caracol(x1,y1,l-7,an+ang2);
    setcolor(c1+c11); caracol(x1,y1,l-1,an+ang3);
  }
}