...
int ang1,ang2,ang3,car,c1,c2,c3,c11,ran,j;
void main()
{
  int br,bg,bb,ba,tam=35,k,k1=0;
  int selecc;
...
void caraco0(int x0,int y0,float l,int an)
{
  ...
  if (l >=1 )               //47, 127, 12
  {
    ...
    if(random(450)==3)for(j=1;j<16;j++){
	escrcolordac16(16-j,l+(j+x1)*3,y1+j+1+x0,y1);
	if(random(3)==1)escrcolordac16(16-j,0,0,0);
	delay(20);}

    if(ran!=0)setcolor(c1+l); caraco0(x0,y0,l-.81,an+ang1);
    if(ran!=0)setcolor(c2+l); caracol0(x1,y1,l-15,an+ang2);
    if(ran!=0)setcolor(c3+l); caracol0(x1,y1,l-7,an+ang3);
  }
}
...
void caraco1(int x0,int y0,float l,int an)
{
  ...
  if (l >=1 )               //47, 127, 12
  {
    ...
    if(ran!=0)setcolor(c3+l); caraco1(x0,y0,l-.51,an+ang1);
    if(ran!=0)setcolor(c2+l); caracol1(x1,y1,l-10,an+ang2);
  }
}
...
void caraco2(int x0,int y0,float l,int an)
{
  ...
  if (l >=1 )               //47, 127, 12
  {
    ...
    if(ran!=0)setcolor(c3+l); caraco2(x0,y0,l-.81,an+ang1);
    if(ran!=0)setcolor(c2+l); caracol2(x1,y1,l-15,an+ang2);
    if(ran!=0)setcolor(c1+l); caracol2(x1,y1,l-7,an+ang3);
  }
}
...
void caracol3(int x0,int y0,float l,int an)
{
  ...
  if (l >=1 )               //47, 127, 12
  {
    ...
    if(ran!=0)setcolor(c3+l); caraco3(x1,y1,l-15,an+ang1);
    if(ran!=0)setcolor(c2+l); caraco3(x1,y1,l-7,an+ang2);
    if(ran!=0)setcolor(c1+l); caraco3(x1,y1,l-1,an+ang3);
  }
}
...
void caraco3(int x0,int y0,float l,int an)
{
  ...
  if (l >=1 )               //47, 127, 12
  {
    ...
    if(ran!=0)setcolor(c3+c11+l); caraco3(x1,y1,l-15,an+ang1);
    if(ran!=0)setcolor(c2+c11+l); caraco3(x1,y1,l-7,an+ang2);
    if(ran!=0)setcolor(c1+c11+l); caraco3(x1,y1,l-1,an+ang3);
  }
}
