...
void caracol(int x0,int y0,float l,int an)
{
  ...
  if (l >=1 )               //47, 127, 12
  {
    ...
    line(x0,y0,x1,y1);
    setcolor(c3); caracol(x0,y0,l-1,an+ang3);
    setcolor(c2); caracol0(x1,y1,l-9,an-ang2);
    setcolor(c1); caracol0(x1,y1,l-9,an+ang2);
  }
}