...
int ang0,ang1,ang2,ang3,car,c1,c2,c3,c11;
void main()
{
  int br,bg,bb,j;
  int selecc;
  ...
  while(car!=27){
    ...
    while((i++)<20){
      ...
      c3-=.6;
      setcolor(c3);
    if(selecc==0) caracol0(250+i*s,250-i,30,ang0);

    if(selecc==1) caracol1(250+i*s,250-i,30,ang0);

    if(selecc==2) caracol2(250+i*s,250-i,30,ang0);

    if(selecc==3) caracol3(250+i*s,250-i,30,ang0);

    if(selecc==4) caracol4(250+i*s,250-i,30,ang0);

    if(selecc==5) caraco3(250+i*s,250-i,30,ang0);
    }
    if (kbhit())car=getch();
    else delay(4000);
    i=0;
