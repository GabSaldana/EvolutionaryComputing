...
for I in range(0, n_particles):
    if f(X_lbest[I])<f(X_gbest[0]):
        X_gbest[0]=1*X_lbest[I]
print "X_gbest desp",X_gbest

t=0
t5=0
def iteracion():
    global X,X_lbest,X_gbest,V,t,t5
# Loop until convergence, in this example a finite number of iterations chosen
    ...
    print "Best particle in:",X_gbest[0]," gbest: ",f(X_gbest[0])
    ...
    for I in range(0, n_particles):
        for J in range(0, n_dimensions):
          ...
          print "inertia: ",weight*V[I][J], " experience: ", C1*R1*(X_lbest[I][J] - X[I][J]) ," lider: " , C2*R2*(X_gbest[J] - X[I][J])
          X[I][J] = X[I][J] + V[I][J]
